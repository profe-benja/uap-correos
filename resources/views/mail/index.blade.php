        ...
        <tr>
            <td align="center" valign="top">
                ...
                <table class="container" border="0" cellpadding="0" cellspacing="0" width="700" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            <table class="container header" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding: 30px 0 30px 0; border-bottom: solid 1px #eeeeee;"
                                        align="left">
                                        <a href="#"
                                            style="font-size: 30px; text-decoration: none; color: #000000;">MP</a>
                                    </td>
                                </tr>
                            </table>
                            <!-- /// Header -->
                            ...
                            <table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="hero-subheader__title"
                                        ...
                                        align="left">Product Design Portfolio</td>
                                </tr>

                                <tr>
                                    <td class="hero-subheader__content"
                                        style="font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;"
                                        align="left">Sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                                        nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.</td>
                                </tr>
                            </table>
                            <!-- /// Hero subheader -->
                                ...
                                <tr>
                                    <td>
                                        <table class="container" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <a href="#"><img src="img/img1.jpg" width="235"
                                                            height="235" border="0" style="display: block;"></a>
                                                </td>

                                                <td align="left">
                                                    <a href="#"><img src="img/img2.jpg" width="235"
                                                            height="235" border="0" style="display: block;"></a>
                                                </td>

                                                <td align="left">
                                                    <a href="#"><img src="img/img3.jpg" width="235"
                                                            height="235" border="0" style="display: block;"></a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <a href="#"><img src="img/img4.jpg" width="235"
                                                            height="235" border="0"
                                                            style="display: block;"></a>
                                                </td>

                                                <td align="left">
                                                    <a href="#"><img src="img/img5.jpg" width="235"
                                                            height="235" border="0"
                                                            style="display: block;"></a>
                                                </td>

                                                <td align="left">
                                                    <a href="#"><img src="img/img6.jpg" width="235"
                                                            height="235" border="0"
                                                            style="display: block;"></a>
                                                </td>
                                            </tr>
                                        ...
                                        <table class="container" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="paragraph-block__content"
                                                    ...
                                                    align="left">Lorem ipsum dolor sit amet, consectetur adipisicing
                                                    elit, sed do eiusmod
                            ...
                            <!-- / Half block -->
                            <table class="container half-block" border="0" cellpadding="0" cellspacing="0"
                                width="100%" style="padding-top: 25px;">
                                <tr>
                                    <td>
                                        <table class="container" border="0" cellpadding="0" cellspacing="0"
                                            width="100%">
                                            <tr>
                                                <td class="half-block__image" style="width: 353px; height: 325px;"
                                                    width="353" height="325" background="img/img14.jpg">
                                                    <!--[if gte mso 9]>
             ...
             <![endif]-->
                                                ...
                                                <td class="half-block__content"
                                                    style="width: 50%; padding: 0 25px 0 25px; font-size: 16px; line-height: 27px; color: #969696; text-align: center;">
                                    ...
                                    <td>
                                        <table class="container" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td class="half-block__image" style="width: 353px; height: 325px;"
                                                    width="353" height="325" background="img/img15.jpg">
                                                    <!--[if gte mso 9]>
             <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 353px; height: 325px;" width="353" height="325">
             ...
             <![endif]-->
                            ...
                            <!-- / CTA Block -->
                            <table class="container cta-block" border="0" cellpadding="0" cellspacing="0"
                                width="100%">
                                <tr>
                                    <td align="center" valign="top">
                                        <table class="container" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table class="container" border="0" cellpadding="0"
                                                        cellspacing="0">
                                                        <tr>
                                                            <td class="cta-block__button" width="230"
                                                                align="center" style="width: 200px;">
                                                                <a href="http://slicejack.com/"
                                                                    style="border: 3px solid #eeeeee; color: #969696; text-decoration: none; padding: 15px 45px; text-transform: uppercase; display: block; text-align: center; font-size: 16px;">Visit
                                                                    Us</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <table class="container" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="text-align: center; padding: 50px 0 10px 0;">
                                                    <a href="#"
                                                        style="font-size: 28px; text-decoration: none; color: #d5d5d5;">MailPortfolio</a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Copyright &copy; 2015 <a href="http://slicejack.com/"
                                                        target="_blank"
                                                        style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color: #d5d5d5;">Slicejack</a>.
